...
| `enableThinking`       | `boolean` | `true` to enable extended reasoning for supported models. Legacy key `enable_thinking` is parsed for backward compatibility but is not schema-valid; new configs must use `enableThinking`.                                                                                                                                                                                                                                                                                                                                               |

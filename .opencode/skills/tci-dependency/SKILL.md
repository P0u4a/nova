---
name: tci-dependency
description: Find circular dependencies, fan-out hubs, and layering violations. Execute topological sort and hub analysis when asked about dependency issues.
---

# TCI Dependency Analysis

Run topological sort (cycle detection) and hub analysis to find dependency issues: cycles, high fan-out, and layering violations.
...
- **Critical** (-15): dependency cycles present, or domain depends on infrastructure
- **Warning** (-5): several DIP violations but no cycles
- **Suggestion** (-1): minor Demeter violations, isolated high fan-out
